...
// const size = rows * cols;
// let imageParts = [];
// let imageWidth = 1024; // Width of the original image
// let imageHeight = 576; // Height of the original image
...
//                 if (average > 100) { // Adjust this threshold according to your environment
//                     shuffle();
//                 }
//             };
...
// function shuffleWithGlitch() {
//     glitchGrid();
//     setTimeout(() => {
//         shuffle();
//     }, 1000); // Wait for a second before shuffling again
// }
...
//     cells.forEach(cell => {
//         cell.style.filter = 'contrast(200%)'; // Apply glitch effect to each cell
//     });
// }
...
//       const cell = document.createElement('div');
//       cell.classList.add('cell');
//       cell.style.backgroundImage = `/image/beach.jpg`;
//       gridContainer.appendChild(cell);
//   }
// }
...
// const size = rows * cols;
// let imageParts = [];
// let imageWidth = 8000; // Width of the original image
// let imageHeight = 3000; // Height of the original image
...
//         cell.classList.add('cell');
//         const cnv = document.createElement('canvas');
//         cnv.classList.add('glitch-canvas');
//         cnv.width = imageWidth / cols;
//         cnv.height = imageHeight / rows;
//         gridContainer.appendChild(cell);
...
//         const img = new Image();
//         img.onload = () => {
//             ctx.drawImage(img, imageParts[i].x, imageParts[i].y, cnv.width, cnv.height);
//             const img_data = cnv.toDataURL("image/jpeg");
//             const glitched_img = new Image();
//             glitched_img.src = glitchify(img_data, 96, 6);
//             glitched_img.onload = () => {
//                 ctx.drawImage(glitched_img, 0, 0, cnv.width, cnv.height);
//             };
//         };
//         img.src = '/image/beach.jpg';
//     }
